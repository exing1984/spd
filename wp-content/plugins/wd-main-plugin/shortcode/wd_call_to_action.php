...
if($button_url != "#") {
    ...
    $button_url = $href['url'];
    $button_target = (isset($href['target']) && $href['target'] != '')? ' target=' . $href['target']  : '';
}
    ob_start(); ?>
    ...
    <div class="row call-to-action<?php echo esc_attr($layout); ?>">
        ...
        <div class="large-4 columns">
            <div class="wd-call-to-action-btn<?php echo esc_attr($layout); ?>">
                <a href="<?php echo esc_attr($button_url); ?>"<?php echo esc_attr($button_target); ?>><?php echo esc_attr($button_text); ?></a>
            </div>
        </div>
    </div>
</section>
