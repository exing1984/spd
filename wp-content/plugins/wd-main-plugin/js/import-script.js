jQuery(document).ready(function ($) {
    ...
    jQuery(document).on('click', '#import_demo_data', function (e) {
        ...
        if (confirm('Are you sure, you want to import Demo Data now?')) {
            ...
            var import_expl = jQuery(".import-demo-screenshot label.label_selected").attr("class");
            import_expl = import_expl.split("label_selected");
            var import_expl = import_expl[0].split(" ")
    
            var import_expl = import_expl[0];
            var p = 0;
