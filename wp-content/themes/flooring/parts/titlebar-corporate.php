...
<section class="wd-title-bar  <?php echo esc_attr($flooring_menu_style) ?>">
  <div class="row">
    <div  class="large-12 columns text-<?php echo esc_attr( $flooring_page_title_position ); ?>">
        <h2 id="page-title" class="title column"><?php
                    if (flooring_is_blog()) {
